...
public class CubeCoordinates<T> : MonoBehaviour where T : Coordinate {
  ...
  // Creates a T GameObject for a given cube coordinate
  ...
  // Removes and destroys a T for a given cube coordinate
  ...
  // Validates all cube coordinate results against instantiated T GameObjects
  ...
  // Returns a T given a cube coordinate and a container key
  ...
  // Adds a given T to the given container key
  ...
  // Removes a given T from the given container key
  ...
  // Removes a given T from all containers
